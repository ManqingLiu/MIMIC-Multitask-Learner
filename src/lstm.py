...
if __name__=="__main__":
    ...
    '''
    target = 'MI'
    drop_cols = drop_cols + ['troponin', 'troponin_std', 'troponin_min', 'troponin_max','DEATHTIME','DEATH']
    model_location = 'models/'+target.lower()+'_lstm'
    '''
    target = 'Sepsis'
    drop_cols = drop_cols + ['hr_sepsis', 'respiratory rate_sepsis', 'wbc_sepsis', 'temperature f_sepsis', 'sepsis_points','DEATHTIME','DEATH']
    model_location = 'models/'+target.lower()+'_lstm'
